...
public class RetailerStartUpScreen extends AppCompatActivity {
    ...
    public void callSignUpScreen(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), TypeOfRegistrationUser.class);

        Pair[] pairs = new Pair[1];
        pairs[0] = new Pair<View, String>(findViewById(R.id.signup_btn), "transition_type_registration");
