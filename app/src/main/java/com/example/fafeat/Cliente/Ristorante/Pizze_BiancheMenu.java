...
public class Pizze_BiancheMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pizze__bianche_menu);

        recyclerView = findViewById(R.id.recyclerviewlistant6);
    ...
    public void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshotRist : dataSnapshot.child("Menu/PizzeBianche").getChildren()) {
