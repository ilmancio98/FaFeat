...
import com.example.fafeat.Cliente.Interface.ItemClickListener;
...
public class CartAdapter extends  RecyclerView.Adapter<CartViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        int price = (Integer.parseInt(listData.get(position).getPrezzo()))*(Integer.parseInt(listData.get(position).getQuantity()));
