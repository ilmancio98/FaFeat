...
public class SecondiMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondi_menu);

        recyclerView = findViewById(R.id.recyclerviewlistant9);
    ...
    public void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshotRist : dataSnapshot.child("Menu/Secondi").getChildren()) {
