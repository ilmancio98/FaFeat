...
public class PaniniMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panini_menu);

        recyclerView = findViewById(R.id.recyclerviewlistant5);
    ...
    public void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshotRist : dataSnapshot.child("Menu/Panini").getChildren()) {
