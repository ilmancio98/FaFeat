...
public class ContorniMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contorni_menu);

        recyclerView = findViewById(R.id.recyclerviewlistant3);
    ...
    public void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshotRist : dataSnapshot.child("Menu/Contorni").getChildren()) {
