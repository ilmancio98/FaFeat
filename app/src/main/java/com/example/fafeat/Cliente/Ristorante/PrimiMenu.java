...
public class PrimiMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_primi_menu);

        recyclerView = findViewById(R.id.recyclerviewlistant8);
    ...
    public void onResume() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshotRist : dataSnapshot.child("Menu/Primi").getChildren()) {
