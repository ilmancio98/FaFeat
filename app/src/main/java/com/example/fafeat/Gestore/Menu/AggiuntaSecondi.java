...
public class AggiuntaSecondi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManagerGestore = new SessionManagerGestore(AggiuntaSecondi.this, SessionManagerGestore.SESSION_USERSESSION);
    ...
    private void createSecondo(String img_path) {
