...
import com.example.fafeat.Databases.Model;
...
public class AggiuntaAntipasti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManagerGestore = new SessionManagerGestore(AggiuntaAntipasti.this, SessionManagerGestore.SESSION_USERSESSION);
        setContentView(R.layout.activity_aggiunta_antipasti);
