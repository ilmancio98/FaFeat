...
public class Pizze_Rosse extends AppCompatActivity {
    ...
    private ArrayList<PietanzaHelperClass> pizze_rosse;
    ...
    protected void onResume() {
        ...
        DatabaseReference root = FirebaseDatabase.getInstance().getReference("Gestori/" + username + "/Ristoranti/Ristorante/Menu/PizzeRosse");
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    pizze_rosse.add(pietanzaHelperClass);
                }
